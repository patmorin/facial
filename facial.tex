...
\begin{proof}
  ...
  on $uw$.  To see why such a $uw$ exists, recall that $G$ has at least
  two inner faces.  The face $F_{uw}$ is a node in the weak dual of $G$
  whose neighbours are all leaves except possibly for the neighbour
  opposite the edge $uw$.  (Note that $v$ may be one of $u$ or $w$.)
